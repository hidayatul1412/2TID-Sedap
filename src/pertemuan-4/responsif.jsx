export default function responsif(){
    return (
...
function ResponsiveText(){
    return (
        <p className="text-sm md:text-lg md:text-blue-500 lg:text-xl lg:text-red-500 xl:text-2xl mb-4">
...
function ResponsiveLayout(){
    return (
        <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-5 gap-4 mt-4">
